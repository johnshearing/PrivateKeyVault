...
Now that the public can set up their own accounts on a super secure device in their own homes or businesses when they are alone, there is never any doubt that only they can command their accounts and that their accounts are safe from hackers and theives.  
This will remove the biggest impediment to wide scale adoption of blockchain technology (Security) and should open the way for all kinds of new services to be hosted on Ethereum and Cardano which will make life better for people all accros the planet.  
