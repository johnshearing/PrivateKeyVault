...
* Now we will be playing the part of Alice.  
  ...
  * If you remember, just before we pulled the plug on the Internet so as to airgap your PrivateKeyVault, we copied this very file that you are reading now onto you pi. It's in a fold named **readme** and file is named readme.txt  
